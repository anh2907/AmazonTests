...
public class DemoTestClass {
    ...
    public void beforeClass(){
        htmlReporter = new ExtentHtmlReporter("./reports/" + getReportName());
    ...
    public void afterMethod(ITestResult result){
        ...
        if (result.getStatus()==ITestResult.FAILURE){
            ...
            extentTest.fail("<details><summary><b><font color= red>Exception occurred, click to see details:"
                    + "</font></b></summary>" +
                    exceptionMessage.replaceAll(",", "br") + "</details> \n");
            String path = takeScreenShot(result.getMethod().getMethodName());
            try {
                extentTest.fail("<b><font color=red>" + " Screenshot of failure: " + path + "</font></b>",
